...
INSERT INTO activity (name,artist,description,begin_time,end_time,perf_type,awesome_Num,usera_id,location_id,activity_status,noticed) values
 ...
 ('甜點藝術','游玄玄','將人們又愛又害怕的甜點做為可愛的飾品或指上玩具等','2019/04/25 07:35','2019/05/01 17:15','創意藝術',421,2,145,1,0),
 ('速描寫真','范成殷','以漫畫方式，描繪人物Q版造型，以素描速字方式呈現人物寫真','2019/03/28 12:03','2019/05/28 12:30','視覺藝術',352,1,144,1,0),
 ('特技表演','創夢行','以不同肢體變化來表現，倒立配合上道具以及各種難度技巧，柔軟的姿態加上平衡去呈現','2019/02/22 23:35','2019/02/23 07:35','表演藝術',785,3,143,1,0),
 ('創新捏麵藝術','吳俊毅','此次展演作品以傳統捏麵技法加以創新元素，作品均為袖珍迷你大小，樣式涵蓋Q版人型，趣味動物，12生肖，花精靈等多元呈現','2019/07/14 07:35','2019/07/14 17:15','創意藝術',384,2,142,1,0),
 ('綜合彩繪','傅遠超','水彩麥克筆等綜合媒材創作','2019/06/27 23:35','2019/06/28 07:35','視覺藝術',292,3,1,1,0),
 ('創新融合音樂','八荒印痕','現代流行的音樂曲風及概念，融合中國傳統樂器的特有音色及風格，創造新音樂型態','2019/04/25 07:35','2019/05/01 17:15','表演藝術',353,1,141,1,0);
