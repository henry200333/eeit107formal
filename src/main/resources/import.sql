...
INSERT INTO activity (name,artist,description,begin_time,end_time,perf_type,awesome_Num,usera_id,location_id,activity_status) values
 ('造型氣球表演','氣球阿明','造型氣球教學、氣球表演、現埸折氣球、活動演出、魔術','2019/03/28 12:03','2019/05/28 12:30','創意藝術',372,1,1,1),
 ('攝影卡片','王怡霖','用復古相機現場為每位在場的朋友拍照，現場貼在卡片上讓每位前來的朋友帶回家','2019/07/25 10:02','2019/07/28 07:35','視覺藝術',219,4,2,1),
 ('吉他彈唱','派派x游偉','不插電演出，木吉他加上歌聲傳達最簡單的感動','2019/07/29 07:35','2019/07/29 17:15','表演藝術',377,4,3,1),
 ('摺紙藝術','鄭皓剛','以紙做為創作的素材，將多面體摺紙、環狀摺紙，應用在紙首飾、紙飾品的創作上，挑戰紙的無限可能性','2019/06/27 23:35','2019/06/28 07:35','創意藝術',227,3,4,1),
 ('創意明信片','梁濯紳','客製著色明信片畫','2019/04/25 07:35','2019/05/01 17:15','視覺藝術',203,2,5,1),
 ('扯鈴技藝','謝孟迪','多顆扯鈴同時演出','2019/03/28 12:03','2019/05/28 12:30','表演藝術',189,1,4,1),
 ('打包帶藝術','白錫石','已打包帶為材料，透過個人巧思編摺成各種動物、昆蟲','2019/02/22 23:35','2019/02/23 07:35','創意藝術',359,3,3,1),
 ('創意繪製','麥考艾裘','搞笑人像繪製','2019/07/14 07:35','2019/07/14 17:15','視覺藝術',278,2,2,1),
 ('抽象人形','林志儒','將抽象畫融入人形裝置，再與觀眾互動','2019/06/27 23:35','2019/06/28 07:35','表演藝術',57,3,1,1),
 ('毛線編織藝術','詹文君','以毛線編織成手機吊飾、鑰匙圈、包包吊飾','2019/04/25 07:35','2019/05/01 17:15','創意藝術',154,1,2,1),
 ('街景藝術','生活狂熱Lifemania','街景攝影即興作畫','2019/03/28 12:03','2019/05/28 12:30','視覺藝術',500,1,1,1),
 ('音樂扯鈴','吳顥中','搭配音樂扯鈴演出','2019/02/22 23:35','2019/02/23 07:35','表演藝術',304,4,2,1),
 ('吹糖技藝','吳秋榮','吹糖技藝，透過邊吹邊捏做出很多動物水果造型','2019/07/14 07:35','2019/07/14 17:15','創意藝術',481,4,3,1),
 ('人像繪畫','賴慶賀','人物肖像或半身現場以水彩繪畫,因寫實畫風,需求神似具備約需30分鐘完成','2019/06/27 23:35','2019/06/28 07:35','視覺藝術',287,3,4,1),
 ('吉他演奏','陳豊緣','吉他自彈自唱、演奏','2019/04/25 07:35','2019/05/01 17:15','表演藝術',371,2,5,1),
 ('藺編技術','郭陳素質','利用藺編技術發揮創意，編長頸鹿、青蛙、小鹿等動物造型DIY，現場十分鐘就可完成，簡單易學。希望能藉此傳承藺編技藝，推廣藺草之美','2019/03/28 12:03','2019/05/28 12:30','創意藝術',167,1,4,1),
 ('藝術彩繪','謝根養','現場彩繪民眾的指甲、手機、小物品例小皮包、皮帶、名片','2019/02/22 23:35','2019/02/23 07:35','視覺藝術',233,3,3,1),
 ('手笛演奏','郭致顯','利用手笛演奏出動人的音樂','2019/07/14 07:35','2019/07/14 17:15','表演藝術',256,2,2,1),
 ('捏麵技藝','周彥吟','以捏麵人呈現人物或動物作為飾品展示','2019/06/27 23:35','2019/06/28 07:35','創意藝術',164,3,1,1),
 ('毛筆速繪','林會強','毛筆速繪人像，用漫畫來呈現趣味性','2019/04/25 07:35','2019/05/01 17:15','視覺藝術',188,1,2,1),
 ('魔術表演','黃仲楷','街頭魔術演出','2019/03/28 12:03','2019/05/28 12:30','表演藝術',376,1,1,1),
 ('隨手藝術','黃朝份','現場利用常見之飲料吸管、鍛帶、打包帶，創作各種動物造型','2019/02/22 23:35','2019/02/23 07:35','創意藝術',258,4,2,1),
 ('溝通繪畫','陳韻如','與民眾溝通及聊天創作出屬於其風格的塗鴉創作','2019/07/14 07:35','2019/07/14 17:15','視覺藝術',317,4,3,1),
 ('音樂小丑','H.J.B.H','透過音樂兩位小丑展開曼妙舞姿，訴說生動幽默的故事，舞動過程中與觀眾互動','2019/06/27 23:35','2019/06/28 07:35','表演藝術',605,3,4,1),
 ('甜點藝術','游玄玄','將人們又愛又害怕的甜點做為可愛的飾品或指上玩具等','2019/04/25 07:35','2019/05/01 17:15','創意藝術',421,2,5,1),
 ('速描寫真','范成殷','以漫畫方式，描繪人物Q版造型，以素描速字方式呈現人物寫真','2019/03/28 12:03','2019/05/28 12:30','視覺藝術',352,1,4,1),
 ('特技表演','創夢行','以不同肢體變化來表現，倒立配合上道具以及各種難度技巧，柔軟的姿態加上平衡去呈現','2019/02/22 23:35','2019/02/23 07:35','表演藝術',785,3,3,1),
 ('創新捏麵藝術','吳俊毅','此次展演作品以傳統捏麵技法加以創新元素，作品均為袖珍迷你大小，樣式涵蓋Q版人型，趣味動物，12生肖，花精靈等多元呈現','2019/07/14 07:35','2019/07/14 17:15','創意藝術',384,2,2,1),
 ('綜合彩繪','傅遠超','水彩麥克筆等綜合媒材創作','2019/06/27 23:35','2019/06/28 07:35','視覺藝術',292,3,1,1),
 ('創新融合音樂','八荒印痕','現代流行的音樂曲風及概念，融合中國傳統樂器的特有音色及風格，創造新音樂型態','2019/04/25 07:35','2019/05/01 17:15','表演藝術',353,1,2,1);
