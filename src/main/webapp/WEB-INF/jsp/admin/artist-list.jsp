...
<body id="page-top">
	...
	<script>
		$("#artistGrid").jqGrid({
			...
			iconSet:'fontAwesome',
			colModel:[
				{ name: 'artistId', label:'artistId', width:5},
				{ name: 'artistName', label:'artistName', width:30},
				{ name: 'wFollowers', label:'wFollowers', width: 30},
				{ name: 'tFollowers', label:'tFollowers', width: 30},
