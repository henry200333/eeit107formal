						...
						<form name="registerform" id="registerform" action="/register"
							...
							<p class="login-username">
								<label for="register_account">Email Address</label> <input
									type="email" name="register_account" id="register_account"
